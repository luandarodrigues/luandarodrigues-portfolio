...
export const homeContent: Record<'en' | 'pt', HomeContent> = {
  en: {
    ...
    about: {
      ...
      accent: 'system.',
      paragraphs: [
        'My trajectory connects Biomedical Engineering, Hospital Management, public-health operations, clinical pharmacy workflows, KPI monitoring, marketing technology, leadership of 10 pharma and health media projects, and AI-assisted projects.',
    ...
    tabs: {
      ...
      method: [
        { label: '01', title: 'Frame the decision', text: 'Define the decision, audience, operational context and success metrics before choosing any technique.', cluster: 'health' },
        { label: '02', title: 'Audit and govern data', text: 'Check granularity, keys, duplicates, nulls, provenance and business rules before trusting the dataset.', cluster: 'health' },
        { label: '03', title: 'Model and integrate sources', text: 'Turn raw files or APIs into clean analytical layers, reusable features and comparable entities.', cluster: 'models' },
        { label: '04', title: 'Choose the analytical lens', text: 'Use BI, statistics, ML, NLP, graph methods or market-intelligence logic according to the decision at stake.', cluster: 'models' },
        { label: '05', title: 'Operationalize and publish', text: 'Package the work into dashboards, reports, case-study sites or interactive apps that people can actually use.', cluster: 'ops' },
      ...
      background: [
        ...
        { label: 'Digital', title: 'Marketing technology & project leadership', text: 'Content, design, HTML email, scientific communication, automation and leadership across 10 pharma/health media projects.' },
      ],
    },
    projects: [
      {
  ...
  pt: {
    ...
    about: {
      ...
      accent: 'sistema.',
      paragraphs: [
        'Minha trajetória conecta Engenharia Biomédica, Gestão Hospitalar, operações em saúde pública, fluxos de farmácia clínica, monitoramento de KPIs, marketing technology, liderança de 10 projetos de mídia para pharma/health e projetos apoiados por IA.',
    ...
    tabs: {
      ...
      method: [
        { label: '01', title: 'Enquadrar a decisão', text: 'Defino a decisão, a audiência, o contexto operacional e as métricas de sucesso antes de escolher qualquer técnica.', cluster: 'health' },
        { label: '02', title: 'Auditar e governar os dados', text: 'Checo granularidade, chaves, duplicatas, nulos, proveniência e regras de negócio antes de confiar no dataset.', cluster: 'health' },
        { label: '03', title: 'Modelar e integrar fontes', text: 'Transformo arquivos brutos ou APIs em camadas analíticas limpas, features reutilizáveis e entidades comparáveis.', cluster: 'models' },
        { label: '04', title: 'Escolher a lente analítica', text: 'Uso BI, estatística, ML, NLP, grafos ou lógica de market intelligence de acordo com a decisão em jogo.', cluster: 'models' },
        { label: '05', title: 'Operacionalizar e publicar', text: 'Empacoto o trabalho em dashboards, relatórios, case-study sites ou apps interativos que as pessoas realmente consigam usar.', cluster: 'ops' },
      ...
      background: [
        ...
        { label: 'Digital', title: 'Marketing technology & liderança de projetos', text: 'Conteúdo, design, HTML email, comunicação científica, automação e liderança em 10 projetos de mídia para pharma/health.' },
      ],
    },
    projects: [
      {
